...
#import "XXEWhoCanSeeMyNameTableViewCell.h"
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    XXEWhoCanSeeMyNameTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    
    if (cell == nil) {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"XXEWhoCanSeeMyNameTableViewCell" owner:self options:nil]lastObject];
    }
