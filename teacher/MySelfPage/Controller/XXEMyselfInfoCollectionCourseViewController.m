...
//
//  XXEMyselfInfoCollectionCourseViewController.m
//  teacher
//
...
#import "XXEMyselfInfoCollectionCourseApi.h"
#import "XXEMyselfInfoDecollectionApi.h"

@interface XXEMyselfInfoCollectionCourseViewController ()<UITableViewDataSource, UITableViewDelegate>
{
...
@implementation XXEMyselfInfoCollectionCourseViewController
...
- (void)fetchNetData{
    ...
    XXEMyselfInfoCollectionCourseApi *myselfInfoCollectionCourseApi = [[XXEMyselfInfoCollectionCourseApi alloc] initWithXid:parameterXid user_id:parameterUser_Id page:pageStr];
    [myselfInfoCollectionCourseApi startWithCompletionBlockWithSuccess:^(__kindof YTKBaseRequest *request) {
        ...
        if ([codeStr isEqualToString:@"1"]) {
            NSArray *modelArray = [XXEMyselfInfoCollectionCourseModel parseResondsData:dict[@"data"]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    XXEMyselfInfoCollectionCourseModel *model = _dataSourceArray[indexPath.row];
    NSString *head_img = [kXXEPicURL stringByAppendingString:model.pic];
    ...
    cell.relationLabel.text = [NSString stringWithFormat:@"现价:%@", model.now_price];
...
#pragma mark - 取消收藏=================================================
        ...
        XXEMyselfInfoCollectionCourseModel *model = _dataSourceArray[path.row];
...
- (void)cancelCollection{
    ...
    XXEMyselfInfoDecollectionApi *myselfInfoDecollectionApi = [[XXEMyselfInfoDecollectionApi alloc] initWithXid:parameterXid user_id:parameterUser_Id collect_id:_collectionId collect_type:@"4" return_param_all:@""];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    XXEMyselfInfoCollectionCourseModel *model = _dataSourceArray[indexPath.row];
    xingClassRoomCourseDetailInfoVC.course_id = model.collectionId;
