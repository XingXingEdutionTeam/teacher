...
- (void)p_setUI
{
    ...
    //self.view.bounds
    UICollectionView *collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, kWidth, kHeight - 64 - 49) collectionViewLayout:flowLayout];
    ...
    //底部按钮
    UIView *bottomView = [[UIView alloc] initWithFrame:CGRectMake(0, [UIScreen mainScreen].bounds.size.height - 44 - 64, [UIScreen mainScreen].bounds.size.width, 44)];
...
//            [hud hide:YES afterDelay:1];
    ...
    NSString *str = [NSString stringWithFormat:@"%@/3 完成", count];
