...
//
//  XXECourseManagerTableViewCell.m
//  teacher
//
...
@implementation XXECourseManagerTableViewCell
...
//        [self.contentView addSubview:_separateImageView];
        ...
        [_lineImageViewOne setImage:[UIImage imageNamed:@"separateLine"]];
        ...
        [_lineImageViewTwo setImage:[UIImage imageNamed:@"separateLine"]];
        ...
        [_lineImageViewThree setImage:[UIImage imageNamed:@"separateLine"]];
