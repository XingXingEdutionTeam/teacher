...
//
//  XXEManagerManagerPrivateViewController.m
//  teacher
//
...
@implementation XXEManagerManagerPrivateViewController
...
- (void)initView{
    ...
    NSMutableArray *titles = [[NSMutableArray alloc] initWithObjects:@"学生管理",@"家长管理", @"教师管理", @"课程管理", nil];
