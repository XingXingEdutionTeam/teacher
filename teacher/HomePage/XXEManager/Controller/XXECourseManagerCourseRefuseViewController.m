...
//
//  XXECourseManagerCourseRefuseViewController.m
//  teacher
//
...
@interface XXECourseManagerCourseRefuseViewController ()<QHNavSliderMenuDelegate, UIScrollViewDelegate, UISearchBarDelegate>
{
...
@implementation XXECourseManagerCourseRefuseViewController
...
- (void)initView{
    ...
    NSMutableArray *titles = [[NSMutableArray alloc] initWithObjects:@"校长驳回",@"平台驳回",nil];
