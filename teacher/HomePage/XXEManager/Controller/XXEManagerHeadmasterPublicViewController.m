...
//
//  XXEManagerHeadmasterPublicViewController.m
//  teacher
//
...
@interface XXEManagerHeadmasterPublicViewController ()<QHNavSliderMenuDelegate, UIScrollViewDelegate, UISearchBarDelegate>
{
...
@implementation XXEManagerHeadmasterPublicViewController
...
- (void)initView{
    ...
    NSMutableArray *titles = [[NSMutableArray alloc] initWithObjects:@"学生管理",@"家长管理", @"教师管理", @"班级管理", @"数据管理", nil];
