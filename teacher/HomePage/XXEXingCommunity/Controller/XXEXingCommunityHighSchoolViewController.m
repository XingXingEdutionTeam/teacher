...
//
//  XXEXingCommunityHighSchoolViewController.m
//  teacher
//
...
@interface XXEXingCommunityHighSchoolViewController ()<UITableViewDelegate, UITableViewDataSource>
{
...
@implementation XXEXingCommunityHighSchoolViewController
...
- (void)fetchNetData{
    /*
     ...
     传参:
     //1:幼儿园  2:小学  3:中学(含初中和高中)  4:培训机构   不传默认1
     page	//分页,不传默认1
     */
    //幼儿园
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    XXEXingCommunityClassesModel *model = _dataSourceArray[indexPath.row];
    /*
     cat	//分类,1:幼儿园  2:小学  3:中学(含初中和高中)  4:培训机构
     id	//文章id
     */
    kindergartenDetailVC.cat = @"3";
