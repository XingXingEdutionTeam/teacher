...
//
//  XXEXingCommunityInstitutionsViewController.m
//  teacher
//
...
@interface XXEXingCommunityInstitutionsViewController ()<UITableViewDelegate, UITableViewDataSource>
{
...
@implementation XXEXingCommunityInstitutionsViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    XXEXingCommunityClassesModel *model = _dataSourceArray[indexPath.row];
    /*
     cat	//分类,1:幼儿园  2:小学  3:初中  4:培训机构 5:高中
     id	//文章id
     */
    kindergartenDetailVC.cat = @"4";
