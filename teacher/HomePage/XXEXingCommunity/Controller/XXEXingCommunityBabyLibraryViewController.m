...
- (void)createContentView{
    ...
    for (int i = 0; i < 6; i++) {
        ...
        UIButton *button = [UIButton createButtonWithFrame:CGRectMake(buttonX, buttonY, buttonWidth, buttonHeight) backGruondImageName:@"" Target:self Action:@selector(buttonClick:) Title:titleArray[i]];
