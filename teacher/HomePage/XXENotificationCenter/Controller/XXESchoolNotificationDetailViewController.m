...
#pragma mark ======== //发布人 bgView ========
    ...
    //标题
    UILabel *titleLabel1 = [UILabel createLabelWithFrame:CGRectMake(10, 10, 70, 20) Font:14 Text:titleArray[0]];
    [cellBgView1 addSubview:titleLabel1];
    
    //内容
    UILabel *contentLabel1 = [UILabel createLabelWithFrame:CGRectMake(titleLabel1.frame.origin.x + titleLabel1.width, titleLabel1.frame.origin.y, KScreenWidth - 100, 20) Font:14 Text:contentArray[0]];//
...
#pragma mark ======== //通知范围 bgView ========
    ...
    //标题
    UILabel *titleLabel2 = [UILabel createLabelWithFrame:CGRectMake(10, 10, 70, 20) Font:14 Text:titleArray[1]];
    [cellBgView2 addSubview:titleLabel2];
    
    //内容
    UILabel *contentLabel2 = [UILabel createLabelWithFrame:CGRectMake(titleLabel2.frame.origin.x + titleLabel2.width, titleLabel2.frame.origin.y, KScreenWidth - 100, 20) Font:14 Text:contentArray[1]];//
...
#pragma mark ======== //通知主题 bgView ========
    ...
    //标题
    UILabel *titleLabel3 = [UILabel createLabelWithFrame:CGRectMake(10, 10, 70, 20) Font:14 Text:titleArray[2]];
    [cellBgView3 addSubview:titleLabel3];
    
    //内容
    UILabel *contentLabel3 = [UILabel createLabelWithFrame:CGRectMake(titleLabel3.frame.origin.x + titleLabel3.width, titleLabel3.frame.origin.y, KScreenWidth - 100, 20) Font:14 Text:contentArray[2]];//
...
#pragma mark ======== //时间 bgView ========
    ...
    //标题
    UILabel *titleLabel4 = [UILabel createLabelWithFrame:CGRectMake(10, 10, 70, 20) Font:14 Text:titleArray[3]];
    [cellBgView4 addSubview:titleLabel4];
    
    //内容
    UILabel *contentLabel4 = [UILabel createLabelWithFrame:CGRectMake(titleLabel4.frame.origin.x + titleLabel4.width, titleLabel4.frame.origin.y, KScreenWidth - 100, 20) Font:14 Text:contentArray[3]];//
