...
#pragma mark ======== //通知主题 bgView ========
    ...
    //标题
    UILabel *titleLabel3 = [UILabel createLabelWithFrame:CGRectMake(10, 10, 70, 20) Font:14 Text:titleArray[1]];
    [cellBgView3 addSubview:titleLabel3];
    
    //内容
    UILabel *contentLabel3 = [UILabel createLabelWithFrame:CGRectMake(titleLabel3.frame.origin.x + titleLabel3.width, titleLabel3.frame.origin.y, KScreenWidth - 100, 20) Font:14 Text:contentArray[1]];//
...
#pragma mark ======== //时间 bgView ========
    ...
    //标题
    UILabel *titleLabel4 = [UILabel createLabelWithFrame:CGRectMake(10, 10, 70, 20) Font:14 Text:titleArray[2]];
    [cellBgView4 addSubview:titleLabel4];
    
    //内容
    UILabel *contentLabel4 = [UILabel createLabelWithFrame:CGRectMake(titleLabel4.frame.origin.x + titleLabel4.width, titleLabel4.frame.origin.y, KScreenWidth - 100, 20) Font:14 Text:contentArray[2]];//
