...
- (void)createContent{
    ...
    pickerView = [[FSImagePickerView alloc] initWithFrame:CGRectMake(10, 10 * kScreenRatioHeight, kWidth - 10 * kScreenRatioWidth * 2, 80 * kScreenRatioHeight) collectionViewLayout:layout1];
