...
//    NSLog(@"%@", _classId);
    ...
    XXECommentRequestApi *commentRequestApi = [[XXECommentRequestApi alloc] initWithXid:parameterXid user_id:parameterUser_Id user_type:USER_TYPE class_id:_classId require_con:@"2" page:pageStr];
