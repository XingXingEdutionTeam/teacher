...
-(void)returnOfGoodsView{
    ...
    UILabel *returnLabel = [UILabel createLabelWithFrame:CGRectMake(kmgar, kmgar/2, klabelW, klabelH) Font:14 Text:@"退货类型:"];
...
//    _relationCombox.delegate = self;
    ...
    UIButton *buyBtn = [UIButton createButtonWithFrame:CGRectMake(kmgar, CGRectGetMaxY(bgHeadView.frame) + kmgar, kWidth - kmgar *2, 42) backGruondImageName:@"login_green" Target:self Action:@selector(returnOfGoodsMessage) Title:@"提     交"];
