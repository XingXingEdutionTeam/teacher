...
#define kImageDefaultName @"article1.jpg"
...
-(instancetype)initWithFrame:(CGRect)frame WithData:(NSArray *)data withSelectIndex:(void (^)(NSInteger, NSInteger, id))selectIndex
{
    ...
    if (self) {
        ...
        */
        ...
        float leftMargin = 0;
        self.rightCollection =[[UICollectionView alloc] initWithFrame:CGRectMake(kLeftWidth+leftMargin,0,kWidth - kLeftWidth/2,frame.size.height + 100) collectionViewLayout:flowLayout];
        self.rightCollection.userInteractionEnabled = YES;
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSDictionary *dict =[[NSDictionary alloc] initWithObjectsAndKeys:[NSString stringWithFormat:@"%ld",(long)_selectIndex],@"selectIndex", nil];
    NSNotification *notification =[NSNotification notificationWithName:@"selectIndex" object:nil userInfo:dict];
    //通过通知中心发送通知
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.price.text = meun.price;
    cell.sale_num.text = meun.sale_num;
    cell.ID = meun.ID;
